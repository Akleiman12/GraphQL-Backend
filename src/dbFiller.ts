...
export class DBFiller {
    ...
    async fillAuthor(){
        ...
        if(this.genresids.length>1){
            for(let i=0; i<(Math.floor((Math.random()*2)+1)); i++){
                newAuthor.genres.push(this.genresids[Math.floor(Math.random()*this.genresids.length)].toString())
            }
        }

        if(this.booksids.length>1){
            for(let i=0; i<(Math.floor((Math.random()*2)+1)); i++){
                newAuthor.books.push(this.booksids[Math.floor(Math.random()*this.booksids.length)].toString())
            }
        }
    ...
    async fillBook(){
        ...
        if(this.genresids.length>1){
            for(let i=0; i<(Math.floor((Math.random()*2)+1)); i++){
                newBook.genres.push(this.genresids[Math.floor(Math.random()*this.genresids.length)].toString())
            }
        }
        
        if(this.authorids.length>1){
            for(let i=0; i<(Math.floor((Math.random()*2)+1)); i++){
                newBook.authors.push(this.authorids[Math.floor(Math.random()*this.authorids.length)].toString())
            }
        }
    ...
    async fillGenre(){
        ...
        if(this.genresids.length>1){
            for(let i=0; i<(Math.floor((Math.random()*2)+1)); i++){
                newGenre.authors.push(this.authorids[Math.floor(Math.random()*this.authorids.length)].toString())
            }
        }
        
        if(this.booksids.length>1){
            for(let i=0; i<(Math.floor((Math.random()*2)+1)); i++){
                newGenre.books.push(this.booksids[Math.floor(Math.random()*this.booksids.length)].toString())
            }
        }
